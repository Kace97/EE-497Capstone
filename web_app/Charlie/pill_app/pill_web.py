...
def template(title = "Current Pill: 0", text = "Home Page", text2="Please scan a pill"):
...
def find_match():
    ...
    code, qrnum, pill, dist = cc.database_match()
    templateData = template(text = 
                        "QR: This is pill #" + qrnum + " (" + str(code) + ")",
                        text2 = 
                        "Encoder: This is pill #" + str(pill) + " (dist: " + str(dist) + ")")
    return render_template('main.html', **templateData)
